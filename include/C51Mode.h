...
//----------------------------------------------------
#define PC0_OUT  RCC->APB2ENR|=1<<4;GPIOC->CRL&=0xFFFFFFF0; GPIOC->CRL|=0x00000003
#define PC1_OUT  RCC->APB2ENR|=1<<4;GPIOC->CRL&=0xFFFFFF0F; GPIOC->CRL|=0x00000030
#define PC2_OUT  RCC->APB2ENR|=1<<4;GPIOC->CRL&=0xFFFFF0FF; GPIOC->CRL|=0x00000300
#define PC3_OUT  RCC->APB2ENR|=1<<4;GPIOC->CRL&=0xFFFF0FFF; GPIOC->CRL|=0x00003000
#define PC4_OUT  RCC->APB2ENR|=1<<4;GPIOC->CRL&=0xFFF0FFFF; GPIOC->CRL|=0x00030000
#define PC5_OUT  RCC->APB2ENR|=1<<4;GPIOC->CRL&=0xFF0FFFFF; GPIOC->CRL|=0x00300000
#define PC6_OUT  RCC->APB2ENR|=1<<4;GPIOC->CRL&=0xF0FFFFFF; GPIOC->CRL|=0x03000000
#define PC7_OUT  RCC->APB2ENR|=1<<4;GPIOC->CRL&=0x0FFFFFFF; GPIOC->CRL|=0x30000000
#define PC8_OUT  RCC->APB2ENR|=1<<4;GPIOC->CRH&=0xFFFFFFF0; GPIOC->CRH|=0x00000003
#define PC9_OUT  RCC->APB2ENR|=1<<4;GPIOC->CRH&=0xFFFFFF0F; GPIOC->CRH|=0x00000030
#define PC10_OUT RCC->APB2ENR|=1<<4;GPIOC->CRH&=0xFFFFF0FF; GPIOC->CRH|=0x00000300
#define PC11_OUT RCC->APB2ENR|=1<<4;GPIOC->CRH&=0xFFFF0FFF; GPIOC->CRH|=0x00003000
#define PC12_OUT RCC->APB2ENR|=1<<4;GPIOC->CRH&=0xFFF0FFFF; GPIOC->CRH|=0x00030000
#define PC13_OUT RCC->APB2ENR|=1<<4;GPIOC->CRH&=0xFF0FFFFF; GPIOC->CRH|=0x00300000
#define PC14_OUT RCC->APB2ENR|=1<<4;GPIOC->CRH&=0xF0FFFFFF; GPIOC->CRH|=0x03000000
#define PC15_OUT RCC->APB2ENR|=1<<4;GPIOC->CRH&=0x0FFFFFFF; GPIOC->CRH|=0x30000000
#define PC0_IN   RCC->APB2ENR|=1<<4;GPIOC->CRL&=0xFFFFFFF0; GPIOC->CRL|=0x00000008
#define PC1_IN   RCC->APB2ENR|=1<<4;GPIOC->CRL&=0xFFFFFF0F; GPIOC->CRL|=0x00000080
#define PC2_IN   RCC->APB2ENR|=1<<4;GPIOC->CRL&=0xFFFFF0FF; GPIOC->CRL|=0x00000800
#define PC3_IN   RCC->APB2ENR|=1<<4;GPIOC->CRL&=0xFFFF0FFF; GPIOC->CRL|=0x00008000
#define PC4_IN   RCC->APB2ENR|=1<<4;GPIOC->CRL&=0xFFF0FFFF; GPIOC->CRL|=0x00080000
#define PC5_IN   RCC->APB2ENR|=1<<4;GPIOC->CRL&=0xFF0FFFFF; GPIOC->CRL|=0x00800000
#define PC6_IN   RCC->APB2ENR|=1<<4;GPIOC->CRL&=0xF0FFFFFF; GPIOC->CRL|=0x08000000
#define PC7_IN   RCC->APB2ENR|=1<<4;GPIOC->CRL&=0x0FFFFFFF; GPIOC->CRL|=0x80000000
#define PC8_IN   RCC->APB2ENR|=1<<4;GPIOC->CRH&=0xFFFFFFF0; GPIOC->CRH|=0x00000008
#define PC9_IN   RCC->APB2ENR|=1<<4;GPIOC->CRH&=0xFFFFFF0F; GPIOC->CRH|=0x00000080
#define PC10_IN  RCC->APB2ENR|=1<<4;GPIOC->CRH&=0xFFFFF0FF; GPIOC->CRH|=0x00000800
#define PC11_IN  RCC->APB2ENR|=1<<4;GPIOC->CRH&=0xFFFF0FFF; GPIOC->CRH|=0x00008000
#define PC12_IN  RCC->APB2ENR|=1<<4;GPIOC->CRH&=0xFFF0FFFF; GPIOC->CRH|=0x00080000
#define PC13_IN  RCC->APB2ENR|=1<<4;GPIOC->CRH&=0xFF0FFFFF; GPIOC->CRH|=0x00800000
#define PC14_IN  RCC->APB2ENR|=1<<4;GPIOC->CRH&=0xF0FFFFFF; GPIOC->CRH|=0x08000000
#define PC15_IN  RCC->APB2ENR|=1<<4;GPIOC->CRH&=0x0FFFFFFF; GPIOC->CRH|=0x80000000
//----------------------------------------------------
#define PD0_OUT  RCC->APB2ENR|=1<<5;GPIOD->CRL&=0xFFFFFFF0; GPIOD->CRL|=0x00000003
#define PD1_OUT  RCC->APB2ENR|=1<<5;GPIOD->CRL&=0xFFFFFF0F; GPIOD->CRL|=0x00000030
#define PD2_OUT  RCC->APB2ENR|=1<<5;GPIOD->CRL&=0xFFFFF0FF; GPIOD->CRL|=0x00000300
#define PD3_OUT  RCC->APB2ENR|=1<<5;GPIOD->CRL&=0xFFFF0FFF; GPIOD->CRL|=0x00003000
#define PD4_OUT  RCC->APB2ENR|=1<<5;GPIOD->CRL&=0xFFF0FFFF; GPIOD->CRL|=0x00030000
#define PD5_OUT  RCC->APB2ENR|=1<<5;GPIOD->CRL&=0xFF0FFFFF; GPIOD->CRL|=0x00300000
#define PD6_OUT  RCC->APB2ENR|=1<<5;GPIOD->CRL&=0xF0FFFFFF; GPIOD->CRL|=0x03000000
#define PD7_OUT  RCC->APB2ENR|=1<<5;GPIOD->CRL&=0x0FFFFFFF; GPIOD->CRL|=0x30000000
#define PD8_OUT  RCC->APB2ENR|=1<<5;GPIOD->CRH&=0xFFFFFFF0; GPIOD->CRH|=0x00000003
#define PD9_OUT  RCC->APB2ENR|=1<<5;GPIOD->CRH&=0xFFFFFF0F; GPIOD->CRH|=0x00000030
#define PD10_OUT RCC->APB2ENR|=1<<5;GPIOD->CRH&=0xFFFFF0FF; GPIOD->CRH|=0x00000300
#define PD11_OUT RCC->APB2ENR|=1<<5;GPIOD->CRH&=0xFFFF0FFF; GPIOD->CRH|=0x00003000
#define PD12_OUT RCC->APB2ENR|=1<<5;GPIOD->CRH&=0xFFF0FFFF; GPIOD->CRH|=0x00030000
#define PD13_OUT RCC->APB2ENR|=1<<5;GPIOD->CRH&=0xFF0FFFFF; GPIOD->CRH|=0x00300000
#define PD14_OUT RCC->APB2ENR|=1<<5;GPIOD->CRH&=0xF0FFFFFF; GPIOD->CRH|=0x03000000
#define PD15_OUT RCC->APB2ENR|=1<<5;GPIOD->CRH&=0x0FFFFFFF; GPIOD->CRH|=0x30000000
#define PD0_IN   RCC->APB2ENR|=1<<5;GPIOD->CRL&=0xFFFFFFF0; GPIOD->CRL|=0x00000008
#define PD1_IN   RCC->APB2ENR|=1<<5;GPIOD->CRL&=0xFFFFFF0F; GPIOD->CRL|=0x00000080
#define PD2_IN   RCC->APB2ENR|=1<<5;GPIOD->CRL&=0xFFFFF0FF; GPIOD->CRL|=0x00000800
#define PD3_IN   RCC->APB2ENR|=1<<5;GPIOD->CRL&=0xFFFF0FFF; GPIOD->CRL|=0x00008000
#define PD4_IN   RCC->APB2ENR|=1<<5;GPIOD->CRL&=0xFFF0FFFF; GPIOD->CRL|=0x00080000
#define PD5_IN   RCC->APB2ENR|=1<<5;GPIOD->CRL&=0xFF0FFFFF; GPIOD->CRL|=0x00800000
#define PD6_IN   RCC->APB2ENR|=1<<5;GPIOD->CRL&=0xF0FFFFFF; GPIOD->CRL|=0x08000000
#define PD7_IN   RCC->APB2ENR|=1<<5;GPIOD->CRL&=0x0FFFFFFF; GPIOD->CRL|=0x80000000
#define PD8_IN   RCC->APB2ENR|=1<<5;GPIOD->CRH&=0xFFFFFFF0; GPIOD->CRH|=0x00000008
#define PD9_IN   RCC->APB2ENR|=1<<5;GPIOD->CRH&=0xFFFFFF0F; GPIOD->CRH|=0x00000080
#define PD10_IN  RCC->APB2ENR|=1<<5;GPIOD->CRH&=0xFFFFF0FF; GPIOD->CRH|=0x00000800
#define PD11_IN  RCC->APB2ENR|=1<<5;GPIOD->CRH&=0xFFFF0FFF; GPIOD->CRH|=0x00008000
#define PD12_IN  RCC->APB2ENR|=1<<5;GPIOD->CRH&=0xFFF0FFFF; GPIOD->CRH|=0x00080000
#define PD13_IN  RCC->APB2ENR|=1<<5;GPIOD->CRH&=0xFF0FFFFF; GPIOD->CRH|=0x00800000
#define PD14_IN  RCC->APB2ENR|=1<<5;GPIOD->CRH&=0xF0FFFFFF; GPIOD->CRH|=0x08000000
#define PD15_IN  RCC->APB2ENR|=1<<5;GPIOD->CRH&=0x0FFFFFFF; GPIOD->CRH|=0x80000000
//----------------------------------------------------
#define PE0_OUT  RCC->APB2ENR|=1<<6;GPIOE->CRL&=0xFFFFFFF0; GPIOE->CRL|=0x00000003
#define PE1_OUT  RCC->APB2ENR|=1<<6;GPIOE->CRL&=0xFFFFFF0F; GPIOE->CRL|=0x00000030
#define PE2_OUT  RCC->APB2ENR|=1<<6;GPIOE->CRL&=0xFFFFF0FF; GPIOE->CRL|=0x00000300
#define PE3_OUT  RCC->APB2ENR|=1<<6;GPIOE->CRL&=0xFFFF0FFF; GPIOE->CRL|=0x00003000
#define PE4_OUT  RCC->APB2ENR|=1<<6;GPIOE->CRL&=0xFFF0FFFF; GPIOE->CRL|=0x00030000
#define PE5_OUT  RCC->APB2ENR|=1<<6;GPIOE->CRL&=0xFF0FFFFF; GPIOE->CRL|=0x00300000
#define PE6_OUT  RCC->APB2ENR|=1<<6;GPIOE->CRL&=0xF0FFFFFF; GPIOE->CRL|=0x03000000
#define PE7_OUT  RCC->APB2ENR|=1<<6;GPIOE->CRL&=0x0FFFFFFF; GPIOE->CRL|=0x30000000
#define PE8_OUT  RCC->APB2ENR|=1<<6;GPIOE->CRH&=0xFFFFFFF0; GPIOE->CRH|=0x00000003
#define PE9_OUT  RCC->APB2ENR|=1<<6;GPIOE->CRH&=0xFFFFFF0F; GPIOE->CRH|=0x00000030
#define PE10_OUT RCC->APB2ENR|=1<<6;GPIOE->CRH&=0xFFFFF0FF; GPIOE->CRH|=0x00000300
#define PE11_OUT RCC->APB2ENR|=1<<6;GPIOE->CRH&=0xFFFF0FFF; GPIOE->CRH|=0x00003000
#define PE12_OUT RCC->APB2ENR|=1<<6;GPIOE->CRH&=0xFFF0FFFF; GPIOE->CRH|=0x00030000
#define PE13_OUT RCC->APB2ENR|=1<<6;GPIOE->CRH&=0xFF0FFFFF; GPIOE->CRH|=0x00300000
#define PE14_OUT RCC->APB2ENR|=1<<6;GPIOE->CRH&=0xF0FFFFFF; GPIOE->CRH|=0x03000000
#define PE15_OUT RCC->APB2ENR|=1<<6;GPIOE->CRH&=0x0FFFFFFF; GPIOE->CRH|=0x30000000
#define PE0_IN   RCC->APB2ENR|=1<<6;GPIOE->CRL&=0xFFFFFFF0; GPIOE->CRL|=0x00000008
#define PE1_IN   RCC->APB2ENR|=1<<6;GPIOE->CRL&=0xFFFFFF0F; GPIOE->CRL|=0x00000080
#define PE2_IN   RCC->APB2ENR|=1<<6;GPIOE->CRL&=0xFFFFF0FF; GPIOE->CRL|=0x00000800
#define PE3_IN   RCC->APB2ENR|=1<<6;GPIOE->CRL&=0xFFFF0FFF; GPIOE->CRL|=0x00008000
#define PE4_IN   RCC->APB2ENR|=1<<6;GPIOE->CRL&=0xFFF0FFFF; GPIOE->CRL|=0x00080000
#define PE5_IN   RCC->APB2ENR|=1<<6;GPIOE->CRL&=0xFF0FFFFF; GPIOE->CRL|=0x00800000
#define PE6_IN   RCC->APB2ENR|=1<<6;GPIOE->CRL&=0xF0FFFFFF; GPIOE->CRL|=0x08000000
#define PE7_IN   RCC->APB2ENR|=1<<6;GPIOE->CRL&=0x0FFFFFFF; GPIOE->CRL|=0x80000000
#define PE8_IN   RCC->APB2ENR|=1<<6;GPIOE->CRH&=0xFFFFFFF0; GPIOE->CRH|=0x00000008
#define PE9_IN   RCC->APB2ENR|=1<<6;GPIOE->CRH&=0xFFFFFF0F; GPIOE->CRH|=0x00000080
#define PE10_IN  RCC->APB2ENR|=1<<6;GPIOE->CRH&=0xFFFFF0FF; GPIOE->CRH|=0x00000800
#define PE11_IN  RCC->APB2ENR|=1<<6;GPIOE->CRH&=0xFFFF0FFF; GPIOE->CRH|=0x00008000
#define PE12_IN  RCC->APB2ENR|=1<<6;GPIOE->CRH&=0xFFF0FFFF; GPIOE->CRH|=0x00080000
#define PE13_IN  RCC->APB2ENR|=1<<6;GPIOE->CRH&=0xFF0FFFFF; GPIOE->CRH|=0x00800000
#define PE14_IN  RCC->APB2ENR|=1<<6;GPIOE->CRH&=0xF0FFFFFF; GPIOE->CRH|=0x08000000
#define PE15_IN  RCC->APB2ENR|=1<<6;GPIOE->CRH&=0x0FFFFFFF; GPIOE->CRH|=0x80000000
//----------------------------------------------------
#define PF0_OUT  RCC->APB2ENR|=1<<6;GPIOF->CRL&=0xFFFFFFF0; GPIOF->CRL|=0x00000003
#define PF1_OUT  RCC->APB2ENR|=1<<6;GPIOF->CRL&=0xFFFFFF0F; GPIOF->CRL|=0x00000030
#define PF2_OUT  RCC->APB2ENR|=1<<6;GPIOF->CRL&=0xFFFFF0FF; GPIOF->CRL|=0x00000300
#define PF3_OUT  RCC->APB2ENR|=1<<6;GPIOF->CRL&=0xFFFF0FFF; GPIOF->CRL|=0x00003000
#define PF4_OUT  RCC->APB2ENR|=1<<6;GPIOF->CRL&=0xFFF0FFFF; GPIOF->CRL|=0x00030000
#define PF5_OUT  RCC->APB2ENR|=1<<6;GPIOF->CRL&=0xFF0FFFFF; GPIOF->CRL|=0x00300000
#define PF6_OUT  RCC->APB2ENR|=1<<6;GPIOF->CRL&=0xF0FFFFFF; GPIOF->CRL|=0x03000000
#define PF7_OUT  RCC->APB2ENR|=1<<6;GPIOF->CRL&=0x0FFFFFFF; GPIOF->CRL|=0x30000000
#define PF8_OUT  RCC->APB2ENR|=1<<6;GPIOF->CRH&=0xFFFFFFF0; GPIOF->CRH|=0x00000003
#define PF9_OUT  RCC->APB2ENR|=1<<6;GPIOF->CRH&=0xFFFFFF0F; GPIOF->CRH|=0x00000030
#define PF10_OUT RCC->APB2ENR|=1<<6;GPIOF->CRH&=0xFFFFF0FF; GPIOF->CRH|=0x00000300
#define PF11_OUT RCC->APB2ENR|=1<<6;GPIOF->CRH&=0xFFFF0FFF; GPIOF->CRH|=0x00003000
#define PF12_OUT RCC->APB2ENR|=1<<6;GPIOF->CRH&=0xFFF0FFFF; GPIOF->CRH|=0x00030000
#define PF13_OUT RCC->APB2ENR|=1<<6;GPIOF->CRH&=0xFF0FFFFF; GPIOF->CRH|=0x00300000
#define PF14_OUT RCC->APB2ENR|=1<<6;GPIOF->CRH&=0xF0FFFFFF; GPIOF->CRH|=0x03000000
#define PF15_OUT RCC->APB2ENR|=1<<6;GPIOF->CRH&=0x0FFFFFFF; GPIOF->CRH|=0x30000000
#define PF0_IN   RCC->APB2ENR|=1<<6;GPIOF->CRL&=0xFFFFFFF0; GPIOF->CRL|=0x00000008
#define PF1_IN   RCC->APB2ENR|=1<<6;GPIOF->CRL&=0xFFFFFF0F; GPIOF->CRL|=0x00000080
#define PF2_IN   RCC->APB2ENR|=1<<6;GPIOF->CRL&=0xFFFFF0FF; GPIOF->CRL|=0x00000800
#define PF3_IN   RCC->APB2ENR|=1<<6;GPIOF->CRL&=0xFFFF0FFF; GPIOF->CRL|=0x00008000
#define PF4_IN   RCC->APB2ENR|=1<<6;GPIOF->CRL&=0xFFF0FFFF; GPIOF->CRL|=0x00080000
#define PF5_IN   RCC->APB2ENR|=1<<6;GPIOF->CRL&=0xFF0FFFFF; GPIOF->CRL|=0x00800000
#define PF6_IN   RCC->APB2ENR|=1<<6;GPIOF->CRL&=0xF0FFFFFF; GPIOF->CRL|=0x08000000
#define PF7_IN   RCC->APB2ENR|=1<<6;GPIOF->CRL&=0x0FFFFFFF; GPIOF->CRL|=0x80000000
#define PF8_IN   RCC->APB2ENR|=1<<6;GPIOF->CRH&=0xFFFFFFF0; GPIOF->CRH|=0x00000008
#define PF9_IN   RCC->APB2ENR|=1<<6;GPIOF->CRH&=0xFFFFFF0F; GPIOF->CRH|=0x00000080
#define PF10_IN  RCC->APB2ENR|=1<<6;GPIOF->CRH&=0xFFFFF0FF; GPIOF->CRH|=0x00000800
#define PF11_IN  RCC->APB2ENR|=1<<6;GPIOF->CRH&=0xFFFF0FFF; GPIOF->CRH|=0x00008000
#define PF12_IN  RCC->APB2ENR|=1<<6;GPIOF->CRH&=0xFFF0FFFF; GPIOF->CRH|=0x00080000
#define PF13_IN  RCC->APB2ENR|=1<<6;GPIOF->CRH&=0xFF0FFFFF; GPIOF->CRH|=0x00800000
#define PF14_IN  RCC->APB2ENR|=1<<6;GPIOF->CRH&=0xF0FFFFFF; GPIOF->CRH|=0x08000000
#define PF15_IN  RCC->APB2ENR|=1<<6;GPIOF->CRH&=0x0FFFFFFF; GPIOF->CRH|=0x80000000
//----------------------------------------------------
#define PG0_OUT  RCC->APB2ENR|=1<<6;GPIOG->CRL&=0xFFFFFFF0; GPIOG->CRL|=0x00000003
#define PG1_OUT  RCC->APB2ENR|=1<<6;GPIOG->CRL&=0xFFFFFF0F; GPIOG->CRL|=0x00000030
#define PG2_OUT  RCC->APB2ENR|=1<<6;GPIOG->CRL&=0xFFFFF0FF; GPIOG->CRL|=0x00000300
#define PG3_OUT  RCC->APB2ENR|=1<<6;GPIOG->CRL&=0xFFFF0FFF; GPIOG->CRL|=0x00003000
#define PG4_OUT  RCC->APB2ENR|=1<<6;GPIOG->CRL&=0xFFF0FFFF; GPIOG->CRL|=0x00030000
#define PG5_OUT  RCC->APB2ENR|=1<<6;GPIOG->CRL&=0xFF0FFFFF; GPIOG->CRL|=0x00300000
#define PG6_OUT  RCC->APB2ENR|=1<<6;GPIOG->CRL&=0xF0FFFFFF; GPIOG->CRL|=0x03000000
#define PG7_OUT  RCC->APB2ENR|=1<<6;GPIOG->CRL&=0x0FFFFFFF; GPIOG->CRL|=0x30000000
#define PG8_OUT  RCC->APB2ENR|=1<<6;GPIOG->CRH&=0xFFFFFFF0; GPIOG->CRH|=0x00000003
#define PG9_OUT  RCC->APB2ENR|=1<<6;GPIOG->CRH&=0xFFFFFF0F; GPIOG->CRH|=0x00000030
#define PG10_OUT RCC->APB2ENR|=1<<6;GPIOG->CRH&=0xFFFFF0FF; GPIOG->CRH|=0x00000300
#define PG11_OUT RCC->APB2ENR|=1<<6;GPIOG->CRH&=0xFFFF0FFF; GPIOG->CRH|=0x00003000
#define PG12_OUT RCC->APB2ENR|=1<<6;GPIOG->CRH&=0xFFF0FFFF; GPIOG->CRH|=0x00030000
#define PG13_OUT RCC->APB2ENR|=1<<6;GPIOG->CRH&=0xFF0FFFFF; GPIOG->CRH|=0x00300000
#define PG14_OUT RCC->APB2ENR|=1<<6;GPIOG->CRH&=0xF0FFFFFF; GPIOG->CRH|=0x03000000
#define PG15_OUT RCC->APB2ENR|=1<<6;GPIOG->CRH&=0x0FFFFFFF; GPIOG->CRH|=0x30000000
#define PG0_IN   RCC->APB2ENR|=1<<6;GPIOG->CRL&=0xFFFFFFF0; GPIOG->CRL|=0x00000008
#define PG1_IN   RCC->APB2ENR|=1<<6;GPIOG->CRL&=0xFFFFFF0F; GPIOG->CRL|=0x00000080
#define PG2_IN   RCC->APB2ENR|=1<<6;GPIOG->CRL&=0xFFFFF0FF; GPIOG->CRL|=0x00000800
#define PG3_IN   RCC->APB2ENR|=1<<6;GPIOG->CRL&=0xFFFF0FFF; GPIOG->CRL|=0x00008000
#define PG4_IN   RCC->APB2ENR|=1<<6;GPIOG->CRL&=0xFFF0FFFF; GPIOG->CRL|=0x00080000
#define PG5_IN   RCC->APB2ENR|=1<<6;GPIOG->CRL&=0xFF0FFFFF; GPIOG->CRL|=0x00800000
#define PG6_IN   RCC->APB2ENR|=1<<6;GPIOG->CRL&=0xF0FFFFFF; GPIOG->CRL|=0x08000000
#define PG7_IN   RCC->APB2ENR|=1<<6;GPIOG->CRL&=0x0FFFFFFF; GPIOG->CRL|=0x80000000
#define PG8_IN   RCC->APB2ENR|=1<<6;GPIOG->CRH&=0xFFFFFFF0; GPIOG->CRH|=0x00000008
#define PG9_IN   RCC->APB2ENR|=1<<6;GPIOG->CRH&=0xFFFFFF0F; GPIOG->CRH|=0x00000080
#define PG10_IN  RCC->APB2ENR|=1<<6;GPIOG->CRH&=0xFFFFF0FF; GPIOG->CRH|=0x00000800
#define PG11_IN  RCC->APB2ENR|=1<<6;GPIOG->CRH&=0xFFFF0FFF; GPIOG->CRH|=0x00008000
#define PG12_IN  RCC->APB2ENR|=1<<6;GPIOG->CRH&=0xFFF0FFFF; GPIOG->CRH|=0x00080000
#define PG13_IN  RCC->APB2ENR|=1<<6;GPIOG->CRH&=0xFF0FFFFF; GPIOG->CRH|=0x00800000
#define PG14_IN  RCC->APB2ENR|=1<<6;GPIOG->CRH&=0xF0FFFFFF; GPIOG->CRH|=0x08000000
#define PG15_IN  RCC->APB2ENR|=1<<6;GPIOG->CRH&=0x0FFFFFFF; GPIOG->CRH|=0x80000000
...
/*****************SW/JTAG引脚功能设置*****************/
#define SWJ_ON        { AFIO->MAPR=(AFIO->MAPR&0xFFF8)|(1<<0); }
#define SWJ_NOJNTRST { RCC->APB2ENR|=0x0001;AFIO->MAPR=(AFIO->MAPR&0xFFF8)|(1<<1); } 
#define SWON_JTAGOFF { RCC->APB2ENR|=0x0001;AFIO->MAPR=(AFIO->MAPR&0xFFF8)|(1<<2); } 
#define SWJ_OFF      { RCC->APB2ENR|=0x0001;AFIO->MAPR=(AFIO->MAPR&0xFFF8)|(1<<3); }  
